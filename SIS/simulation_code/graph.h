...
private:
    ...
    std::vector<int> states;                    // Vector of states

public:

    // 1. CONSTRUCTOR METHODS

    // Constructor for graph with V vertices
    graph(int V)
    {
        adjlist.resize(V);
        states.resize(V);
    ...
    // Constructor for graph with adjacency list, adj, and states, st
